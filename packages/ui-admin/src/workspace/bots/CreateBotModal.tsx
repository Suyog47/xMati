...
class CreateBotModal extends Component<Props, State> {
  ...
  handleNameChanged = e => {
    ...
    this.setState({ botName, botId: botName.toLowerCase().replace(/[^a-z0-9]/g, '') })
  }
    ...
    const channelInstructions = {
      ...
      slack: `
        <ol>
          ...
          <li>Set the Request URL to:- <b>'https://180c-120-138-99-29.ngrok-free.app/api/v1/messaging/webhooks/${botId}/slack/events'</b></li>
