...
const CustomerWizard: React.FC = () => {
  ...
  const createBot = async () => {
    try {
      ...
      let res = await api.getSecured({ timeout: ms('8m') }).post('/admin/workspace/bots', newBot)
      return true
    } catch (error) {
      const errorMsg =
      ...
      case 'Slack':
        return (
          <ol>
            ...
            <li>Set the Request URL to:- <b>'https://180c-120-138-99-29.ngrok-free.app/api/v1/messaging/webhooks/{botId}/slack/interactive'</b></li>
            ...
            <li>Set the <b>Request URL</b> to:- <b>'https://180c-120-138-99-29.ngrok-free.app/api/v1/messaging/webhooks/{botId}/slack/events'</b></li>
      ...
      case 'Facebook Messenger':
        return (
          <ol>
            ...
            <li>Go back to the <b>Facebook App</b> page and under <b>Configure Webhooks</b>, Enter the Callback URL:- <b>https://180c-120-138-99-29.ngrok-free.app/api/v1/messaging/webhooks/{botId}/messenger</b></li>
